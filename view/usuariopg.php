    ...
    <div class="container">
        <div class="row justify-content-center center text-left">
            <div class="col-lg-6 col-md-8 col-sm-12">
                <form name="editarusuario" action="" method="post" enctype="multipart/form-data" class="bg-dark p-4 text-light rounded shadow">
                    <?php
                    if ($img = $fotoDAO->pegarFoto($dados['us_cod'])) {
                        if (file_exists('img/usuarios/' . $img['foto_img'])) {
                    ?>
                            <div class="form-group text-center">
                                <img class="rounded w-25" src="img/usuarios/<?= $img['foto_img']; ?>" />
                            </div>
                    <?php
                        }
                    }
                    ...
                    <div class="form-group text-center">
                        <input type="submit" value="Atualizar" id="atualizar" name="atualizar" class="btn btn-outline-info">
                    </div>
                    <div class="form-group text-center">
